...
def evaluate(ckpt_path, subset, batch_size, output_file_path, user_dir,
    ...
    for batch in batch_itr:
        with torch.no_grad():
            ...
            y_pred_list.append(class_preds)
            y_true_list.append(class_labels)

            y_pred_reg_list.append(reg_logits)
            y_true_reg_list.append(reg_targets)
    ...
    sed_metric = compute_sed_scores(
        sed_pred, sed_gt, nb_label_frames_1s_100ms)
