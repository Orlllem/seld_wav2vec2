# Parameters used in the feature extraction, neural network model, and
# training the SELDnet can be changed here.
#
# Ideally, do not change the values of the default parameters.
# Create separate cases with unique <task-id> as seen in
# the code below (if-else loop) and use them.
# This way you can easily reproduce a configuration on a later time.
...
def get_params(argv='1'):
    ...
    # ########### default parameters ##############
    params = dict(
        # To do quick test. Trains/test on small subset of dataset, and # of epochs
        quick_test=True,
        ...
        feat_label_dir='/scratch/asignal/sharath/DCASE2020_SELD_dataset/feat_label/',
    ...
    feature_label_resolution = int(
        params['label_hop_len_s'] // params['hop_len_s'])
    params['feature_sequence_length'] = params['label_sequence_length'] * \
        feature_label_resolution
    params['t_pool_size'] = [
        feature_label_resolution, 1, 1]     # CNN time pooling
